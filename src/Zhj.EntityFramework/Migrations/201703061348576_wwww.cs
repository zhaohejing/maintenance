    ...
    public partial class wwww : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        BinaryType = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.Id);
            ...
            CreateTable(
                ...
                annotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_DeviceAttach_SoftDelete", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.DeviceFaultInfo", t => t.DeviceId, cascadeDelete: true)
                .Index(t => t.DeviceId);
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        DeviceType = c.String(),
                        DeviceAssetNo = c.String(nullable: false, maxLength: 50),
                        DeviceAlias = c.String(),
                        DeviceManufacture = c.String(),
                        DeviceHead = c.String(),
                        DeviceSIgnkey = c.String(),
                        DeviceLocation = c.String(),
                        LastRepairTime = c.DateTime(),
                        EnginerId = c.Long(),
                        DeviceDescription = c.String(maxLength: 500),
                ...
                annotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_DeviceFaultInfo_SoftDelete", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.AbpUsers", t => t.EnginerId)
                .Index(t => t.EnginerId);
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        KnowledgeType = c.Int(nullable: false),
                        KnowledgeState = c.Int(nullable: false),
                        IsDeleted = c.Boolean(nullable: false),
                        CreationTime = c.DateTime(nullable: false),
                        CreatorUserId = c.Long(),
                    },
                annotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_KnowledgeBase_SoftDelete", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                })
                .PrimaryKey(t => t.Id);
            
            CreateTable(
                "dbo.KnowledgeComment",
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                ...
                annotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_KnowledgeComment_SoftDelete", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.AbpUsers", t => t.UserId, cascadeDelete: true)
                .ForeignKey("dbo.KnowledgeBase", t => t.KnowledgeId, cascadeDelete: true)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.KnowledgeComment", "KnowledgeId", "dbo.KnowledgeBase");
            DropForeignKey("dbo.KnowledgeComment", "UserId", "dbo.AbpUsers");
            DropForeignKey("dbo.AbpFeatures", "EditionId", "dbo.AbpEditions");
            DropForeignKey("dbo.DeviceFaultInfo", "EnginerId", "dbo.AbpUsers");
            ...
            DropForeignKey("dbo.DeviceAttach", "DeviceId", "dbo.DeviceFaultInfo");
            ...
            DropIndex("dbo.KnowledgeComment", new[] { "UserId" });
            DropIndex("dbo.KnowledgeComment", new[] { "KnowledgeId" });
            ...
            DropIndex("dbo.DeviceFaultInfo", new[] { "EnginerId" });
            DropIndex("dbo.DeviceAttach", new[] { "DeviceId" });
            ...
            DropTable("dbo.KnowledgeComment",
                removedAnnotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_KnowledgeComment_SoftDelete", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                });
            ...
            DropTable("dbo.DeviceFaultInfo",
                removedAnnotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_DeviceFaultInfo_SoftDelete", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                });
            DropTable("dbo.DeviceAttach",
                removedAnnotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_DeviceAttach_SoftDelete", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                });
