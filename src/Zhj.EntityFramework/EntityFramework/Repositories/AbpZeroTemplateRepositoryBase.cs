...
namespace MyCompanyName.AbpZeroTemplate.EntityFramework.Repositories
{
    ...
    public abstract class AbpZeroTemplateRepositoryBase<TEntity, TPrimaryKey> : EfRepositoryBase<ZhjDbContext, TEntity, TPrimaryKey>
        where TEntity : class, IEntity<TPrimaryKey>
    {
        protected AbpZeroTemplateRepositoryBase(IDbContextProvider<ZhjDbContext> dbContextProvider)
